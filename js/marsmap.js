...
function initMapMars() {
  ...
  mapM.mapTypes.set('elevation', makeMarsMapType('elevation'));
  mapM.mapTypes.set('visible', makeMarsMapType('visible'));
  mapM.mapTypes.set('infrared', makeMarsMapType('infrared'));
  mapM.setMapTypeId('elevation');
}
